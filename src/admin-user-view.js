...
function ensureStyles() {
  if (document.querySelector('link[data-admin-user-view-styles="true"]')) return;
  const link = document.createElement("link");
  link.rel = "stylesheet";
  link.href = "./styles/admin-user-view.css?v=20260815.10";
  link.dataset.adminUserViewStyles = "true";
